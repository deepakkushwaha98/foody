    ...
    <div className='min-h-screen w-full flex items-center justify-center p-4 ' style={{backgroundColor:bgColor}}>
        <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{ border: `1px solid ${borderColor}` }} >
            ...
            <p>"Sign in using your email and password to access your account and continue."</p>
             ...
             <div className='mb-4'>
                ...
                <div className='relative'>
                    <input type={showPassword? "text": "password"} value={password} onChange={(e) => setPpassword(e.target.value)} required className='w-full border rounded-lg px-3 py-2 focus-outline-none focus:border-orange-500' placeholder='enter password' style={{ border: `1px solid ${borderColor}` }} />
             ...
             <button className="w-full mt-4 py-2 rounded-lg bg-[#de5b44]  hover:bg-[#e64323] cursor-pointer text-white transition" onClick={handleSignIn} disabled = {loading} >
            ...
            <button className='w-full mt-4 flex items-center py-2 justify-center gap-2 px-4 transition duration-200 border rounded-lg 
             border-gray-400 hover:bg-gray-100' onClick={handleGoogleAuth}>< FcGoogle size={20} />Sign In with google</button>
               
             {err && <p className='text-red-500 text-center m-3'>{err}</p>}
