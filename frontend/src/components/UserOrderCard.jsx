  ...
  return (
    <div className='bg-white rounded-lg shadow p-4 space-y-4'>
      ...
      <div className='flex justify-between border-b pb-2'>
        ...
        <div className='text-right'>
          <p className='text-sm text-gray-500'>{data.paymentMethod?.toUpperCase()}</p>
           <p className='text-sm text-blue-600'>{data.shopOrders?.[0].status}</p>
        </div>
     ...
     <div className='flex justify-between items-center border-t pt-2'>
       ...
       <button className='bg-[#ff4d2d] transition-all hover:bg-[#d63818] text-white px-4 py-2 rounded-lg text-sm '>Track Order</button>
     </div>
